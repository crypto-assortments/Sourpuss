...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PUSS");
    case mBTC: return QString("mPUSS");
    case uBTC: return QString::fromUtf8("μPUSS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SourPusss"));
    case mBTC: return QString(QObject::tr("Milli-SourPusss (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SourPusss (1 / 1,000,000)"));
    default: return QString("???");
    }
}
