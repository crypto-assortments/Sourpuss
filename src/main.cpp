...
unsigned int nStakeMinAge = 1 * 60; //  days as zero time weight
unsigned int nStakeMaxAge = 30 * 24 * nOneHour; //  days as full weight
int64_t nStakeTargetSpacing = 3 * 60; // 2-minute stakes spacing
...
const string strMessageMagic = "SourPuss Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("SourPuss-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SourPuss
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // SourPuss: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SourPuss", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Review: Justice League: Not the most original, but fun nonetheless";
        CTransaction txNew;
        txNew.nTime = 1511161118;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511161118;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 871920 : 871920;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
        //assert(block.hashMerkleRoot == uint256("0x2030e154c4d4c6858342de088ce9212d9b710321bff9a8799632ec1fe04031f9"));
...
unsigned char pchMessageStart[4] = { 0x5f, 0xf6, 0xa4, 0xb7 };
